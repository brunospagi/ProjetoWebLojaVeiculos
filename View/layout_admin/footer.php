...
<script src="../View/assets/site/js/materialize.js"></script>
<script src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.js"></script>
<script src="../View/assets/admin/js/init.js"></script>
<script src="../View/assets/admin/js/jquery.maskedinput-1.1.4.pack.js"></script>
<script src="../View/assets/admin/js/jquery.maskMoney.min.js"></script>
<script src="../View/assets/admin/js/viacep.js"></script>
